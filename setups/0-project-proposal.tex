...
\title{Image-Based Property Change Detection and Classification Using Neural Networks for Inspection Assessment }
\subtitle{
    Word Count: \textbf{[1106 WORDS | %
    Submitted on: \textbf{20-01-2026} ]
}
}
