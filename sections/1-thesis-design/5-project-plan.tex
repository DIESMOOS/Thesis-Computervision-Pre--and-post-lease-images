...
\textbf {Sprint 6 (Mar 16--29):} Submit March milestone; finalize data preparation and evaluation setup. \\
...
\textbf{Sprint 10 (May 11--May 24):} Design LLaVA prompt templates; run foundation-model inference; extract structured outputs Midterm (19 May). \\

\textbf{Sprint 11 (May 25--Jun 7):} Quantitative comparison; robustness testing, finalize output harmonization Pre-Draft (25 May). &
